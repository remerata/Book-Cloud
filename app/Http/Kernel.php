...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \Fruitcake\Cors\HandleCors::class,  // Add this middleware for CORS handling
     ...
     *
     * These middleware are assigned to groups for easy access.
     *
     * @var array
     */
    protected $middlewareGroups = [
        'web' => [
            ...
            \Illuminate\Cookie\Middleware\AuthorizeCookies::class,
